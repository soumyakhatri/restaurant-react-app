...
function Footer() {
    return (
        <div className="footer" id="footer" data-aos="fade-in" data-aos-delay="100">
                ...
                <div className="row py-5">
                    ...
                    <div className="col-md-4 d-flex flex-column align-items-center mt-5 mt-md-0 footer-hours">
                        ...
                        <div className="d-flex icons">
                            <a><i className="fab fa-cc-paypal mx-1"></i></a>
                            <a><i className="fab fa-cc-mastercard mx-1"></i></a>
                            <a><i className="fab fa-cc-visa mx-1"></i></a>
                            <a><i className="fab fa-cc-amex mx-1"></i></a>
                        </div>
                    </div>
                    <div className="col-md-4 d-flex flex-column align-items-center mt-5 mt-md-0 footer-hours">
                        ...
                        <div className="d-flex icons">
                            <a><i className="fab fa-facebook-f mx-1"></i></a>
                            <a><i className="fab fa-youtube mx-1"></i></a>
                            <a><i className="fab fa-twitter mx-1"></i></a>
                            <a><i className="fas fa-utensils mx-1"></i></a>
                        </div>
                    </div>
                </div>
